...
NLLB_FINETUNED_MODEL_DIR = os.getenv("NLLB_FINETUNED_MODEL_DIR") or r"D:\K2C_Translator_Plus\translated models\NLLB200\_1st\merged_model"
...
ttk.Label(main_frame, text="NLLB-200 本地翻译 V3.1 (基础模型 / 微调模型)", style="Header.TLabel").pack(pady=(0, 20))
